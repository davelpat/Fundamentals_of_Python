"""
Instructions for programming Exercise 9.3

The str method of the Bank class returns a string containing the accounts in
random order. Design and implement a change that causes the accounts to be
placed in the string by order of name. (Hint: You will also have to define some
...
class Bank:
    ...
    def __str__(self):
        ...
        for key in self.getKeys():
            description += str(self.accounts.get(key, None)) + "\n"
        return description
...
def main(number=10, fileName=None, save=False):
